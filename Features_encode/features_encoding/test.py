...
sequence='ILRRTASAPAKGRKKSKMGFQEMVEIK'
...
one_code=np.array(one_code)
print(one_code.shape)
...
for key in blosum62:
    for index, value in enumerate(blosum62[key]):
        ...
        #归一化处理：
        blosum62[key][index]=round(blosum62[key][index] - Min_value / (Max_value -Min_value), 3)
print(blosum62)